...
pub struct TranscriptUpdate {
    ...
    /// Which channel's energy dominated this segment: "mic", "system", or
    /// `None` when comparable (cross-talk). See AudioPipeline::log_window_energy.
                ...
                loop {
                    ...
                    match chunk {
                        Some(chunk) => {
                            ...
                            let chunk_speaker = chunk.dominant_speaker.clone();
